/*
** test_main.cpp for EPITECH_42_CPP_POOL in
* /home/paradis/Workspace/Development/CPP/EPITECH_42_CPP_POOL/CPP_02/EPITECH/D08/ex03/test/bin
**
** Made by Paradis
** Login <Adil Denia>
**
** Started on Tue Mar 11 5:56:14 PM 2025 Paradis
** Last update Wed Mar 18 4:17:48 PM 2025 Paradis
*/
...
{
    {
        ...
        c[4] = 0;   // MEMORY LEAKS BUT NO CHOICE IF WE WANT RESPECT THE SUBJECTEPI 
        (~c)(-15, 4);
        std::cout << c << std::endl;
    }
    cr_assert_stdout_eq_str(
