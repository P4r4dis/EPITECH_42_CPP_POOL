...
/*   Updated: 2025/04/30 18:44:55 by Paradis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void)    :   _name("ClapTrap"),
                                ...
                                _attack(0)
{
    std::cout << "ClapTrap " << _name << " Default CTOR called" << std::endl;
}
...
ClapTrap::ClapTrap(const std::string &name) :   _name(name),
                                                ...
                                                _attack(0)
{
    std::cout << "ClapTrap " << _name << " Custom CTOR called" << std::endl;
}
...
{
    std::cout << "ClapTrap " << _name << " Copy CTOR called" << std::endl;
}
