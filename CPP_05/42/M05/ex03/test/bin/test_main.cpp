...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/18 17:16:25 by Paradis           #+#    #+#             */
/*   Updated: 2025/06/18 19:39:32 by Paradis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// //                            Intern class                                   //
// ///////////////////////////////////////////////////////////////////////////////
Test(Intern_CTOR, TEST_CTOR_correctly_created, .init = redirect_all_stdout)
{
    {
        Intern   intern;
        
        cr_assert_not_null(&intern);
    }
}

Test(Intern_copy_CTOR, TEST_simple_copy,
    .init = redirect_all_stdout)
{
    Intern   intern;
    Intern   copy(intern);
...
Test(Intern_assignment_operator,
    TEST_simple_assignement, .init = redirect_all_stdout)
{
    Intern   intern;
    Intern   assigned;
...
Test(Intern_makeForm,
    TEST_Form_name_doesnt_exist_should_return_nullptr, .init = redirect_all_stdout)
{
    Intern intern;
    
    cr_assert_null(intern.makeForm("form", "Bob"));
    cr_assert_stdout_eq_str("Error: Form name doesn't exist.\n");
}

Test(Intern_makeForm,
    TEST_intern_create_Shruberry_form, .init = redirect_all_stdout)
{
    Intern intern;

    AForm *form = intern.makeForm("shrubbery creation", "Bob");
    cr_assert_not_null(form);
    cr_assert_stdout_eq_str("Intern creates ShrubberyCreationForm\n");
    delete form;
}

Test(Intern_makeForm,
    TEST_intern_create_Robotomy_Request_form, .init = redirect_all_stdout)
{
    Intern intern;

    AForm *form = intern.makeForm("robotomy request", "Bob");
    cr_assert_not_null(form);
    cr_assert_stdout_eq_str("Intern creates RobotomyRequestForm\n");
    delete form;
}

Test(Intern_makeForm,
    TEST_intern_create_Presidential_pardon_form, .init = redirect_all_stdout)
{
    Intern intern;

    AForm *form = intern.makeForm("presidential pardon", "Bob");
    cr_assert_not_null(form);
    cr_assert_stdout_eq_str("Intern creates PresidentialPardonForm\n");
    delete form;
}
///////////////////////////////////////////////////////////////////////////////
//                            TEST main                                      //
...
Test(main, Test_main, .init = redirect_all_stdout)
{
    ...
    (
        ...
        "Intern creates the form that does not exist:\n"
        "Error: Form name doesn't exist.\n"
    );
}