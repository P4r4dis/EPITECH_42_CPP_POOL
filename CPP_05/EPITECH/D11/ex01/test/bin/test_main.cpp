/*
** test_main.cpp for EPITECH_42_CPP_POOL in /home/paradis/Workspace/Development/CPP/EPITECH_42_CPP_POOL/CPP_05/EPITECH/D11/ex01/test/bin
**
** Made by Paradis
** Login   <Adil Denia>
**
...
Test(IDirectoryLister__OpenFailureException_what,
Test_catch_and_throw_OpenFailureException,
.init = redirect_all_stdout)
{
    cr_assert_throw(throw IDirectoryLister::OpenFailureException(),
                    IDirectoryLister::OpenFailureException);
    try
    {
...
Test(IDirectoryLister__NoMoreFileException_what,
Test_catch_and_throw_NoMoreFileException,
.init = redirect_all_stdout)
{
    cr_assert_throw(throw IDirectoryLister::NoMoreFileException(),
                    IDirectoryLister::NoMoreFileException);
    try
    {
        throw IDirectoryLister::NoMoreFileException();
    } catch (IDirectoryLister::NoMoreFileException &e) {
        std::cerr << e.what() << std::endl;
    }
    cr_assert_stderr_eq_str
    (
