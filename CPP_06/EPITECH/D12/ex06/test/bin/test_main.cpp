/*
** test_main.cpp for EPITECH_42_CPP_POOL in /home/paradis/Workspace/Development/CPP/EPITECH_42_CPP_POOL/CPP_06/EPITECH/D12/ex06/test/bin
**
** Made by Paradis
** Login   <Adil Denia>
**
** Started on  Thu Aug 7 4:56:19 PM 2025 Paradis
** Last update Wed Aug 26 3:46:38 PM 2025 Paradis
*/
...
Test(Toy_speak, test_method_speak_overload, .init = redirect_all_stdout)
{
    {
...
Test(Toy_left_stream_operator, Test_should_print_Toy_name_and_his_picture,
    .init = redirect_all_stdout)
{
    {
...
Test(Toy_speak_es, Test_speak_es_is_defined,
.init = redirect_all_stdout)
{
    {
        Toy a(Toy::BASIC_TOY, "REX", "./file/example.txt");
...
//                            ToyStory class                                 //
///////////////////////////////////////////////////////////////////////////////
Test(ToyStory_printToyPictures, test_cant_print_picture,
    .init = redirect_all_stdout)
{
    {
        Buzz    b("buzzi");
...
Test(ToyStory_printToyPictures, test_should_print_Toy1_and_Toy2_pictures,
    .init = redirect_all_stdout)
{
    {
        Buzz    b("buzzi");
        ...
        cr_assert(b.setAscii("./file/buzz.txt") == true);
        cr_assert(w.setAscii("./file/woody.txt") == true);
...
Test(ToyStory_tellMeAStory,
    test_file_passed_as_parameter_cant_be_opened_or_read_should_print_msg,
    .init = redirect_all_stdout)
{
    {
        Buzz    b("buzzi");
        ...
        ToyStory::tellMeAStory("./file/badStory.txt",
                                b, &Toy::speak_es,
                                w, &Toy::speak);
    }
    cr_assert_stdout_eq_str
...
Test(ToyStory_tellMeAStory,
    test_file_passed_as_parameter_can_be_opened_and_call_functions,
    .init = redirect_all_stdout)
{
    {
        Buzz    b("buzzi");
        ...
        ToyStory::tellMeAStory("./file/superStory2.txt",
                                b, &Toy::speak_es,
                                w, &Toy::speak);
    }
    cr_assert_stdout_eq_str
...
"        /__.'     `.__l\n"
"\n"
"BUZZ: buzzi senorita \"hi\" senorita\n"
"             _\n"
"            (,)\n"
"            _/\n"
"        .--\"_\"--.\n"
...
"WOODY: wood \"nothing special\"\n"
        ...
        "      _l__|__/_\n"
        "     `\"\"\"\"`\"\"\"\"`\n"
"BUZZ: buzzi senorita \"CU\" senorita\n"
    );
}

Test(ToyStory_tellMeAStory,
    test_Toy1_picture_doesnt_existe_should_call_error_and_stop_running,
    .init = redirect_all_stdout)
{
    {
        Buzz    b("buzzi");
        ...
        ToyStory::tellMeAStory("./file/superStory2WithErrorPictureToy1.txt",
                                b, &Toy::speak_es,
                                w, &Toy::speak);
    }
    cr_assert_stdout_eq_str
...
Test(ToyStory_tellMeAStory,
    test_Toy2_picture_doesnt_existe_should_call_error_and_stop_running,
    .init = redirect_all_stdout)
{
    {
        Buzz    b("buzzi");
        ...
        ToyStory::tellMeAStory("./file/superStory2WithErrorPictureToy2.txt",
                                b, &Toy::speak_es,
                                w, &Toy::speak);
    }
    cr_assert_stdout_eq_str
...
Test(ToyStory_tellMeAStory,
    test_Toy2_with_wrong_function_should_call_error_and_stop_running,
    .init = redirect_all_stdout)
{
    {
        Buzz    b("buzzi");
        ...
        ToyStory::tellMeAStory("./file/superStory.txt",
                                b, &Toy::speak_es,
                                w, &Toy::speak_es);
    }
    cr_assert_stdout_eq_str
